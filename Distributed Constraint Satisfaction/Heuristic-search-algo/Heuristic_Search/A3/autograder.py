...
def question_3():
    ...
    if fails[2]:
        print("\nFail Q3 test 3\nErrors were generated on the following code: ")
        print("python 2.7 sudoku.py -e -m neq 1")
    else:
    ...
    vars.sort(key=lambda var: var.name())
    soln_doms = [
            set([2, 4, 5, 8]), set([6]), set([2, 4, 5, 8]), set([1]),
            set([2, 5, 8]), set([3, 8]), set([7, 9]), set([3, 5, 7, 8]),
            set([3, 7, 8, 9]), set([1, 2, 5, 8]), set([1, 2, 5, 8]),
            ...
            set([1]), set([6]), set([3]), set([9]), set([2, 4, 7]), set([2, 4, 7]),
            set([5]), set([5, 9]), set([5, 7]), set([5, 6, 9]), set([8]),
            set([4]), set([2]), set([1, 6, 7, 9]), set([3, 6, 7]), set(1, 3, 6, 7, 9),
            set([3]), set([2, 4]), set([2, 4, 6, 9]), set([5]),
            set([1]), set([7]), set([8]), set([2, 4, 6]), set([6, 9]),
            set([6]), set([2, 4, 5, 8]), set([2, 4, 5, 8]), set([2, 7]),
            set([9]), set([4, 8]), set([3]), set([1]), set([7, 8]), set([7]),
            set([1, 2, 3, 4, 8]), set([2, 4, 8, 9]), set([2, 3]), set([2, 6, 8]),
            set([1, 3, 4, 6, 8]), set([5]), set([2, 4, 6, 8]), set([6, 8]),
            set([1, 2, 4, 8]), set([1, 2, 3, 4, 8]), set([2, 4, 8]),
...
def question_6():
    ...
    def do_test(
            n, cmd, pi, nsolns, complete=True
    ):
        solns = solve_planes(pi, 'GAC', complete, 'rmv', True)
        if len(solns) != nsolns:
            fails[n] = True
...
def outputGrades():
    ...
    print(
        "The mark given by the autograder is not your necessarily your final work. We might make other adjustments"
    )
