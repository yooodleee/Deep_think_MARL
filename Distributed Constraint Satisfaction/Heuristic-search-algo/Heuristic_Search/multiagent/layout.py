...
class Layout:
    """A Layout manages the static info about the game board."""
    ...
    def getFuthestCorner(self, pacPos):
        poses = [
            (1, 1), (1, self.height - 2),
            (self.width - 2, 1),
            (self.width - 2, self.height - 2)
    ...
    def processLayoutText(self, layoutText):
        ...
        The shape of the maze. Each character represents
        a different type of obj.
        % - Wall
        . - Food
        o - capsule
        G- Ghost
